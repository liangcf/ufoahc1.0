...
class MysqliStmt
{
    ...
    function __construct(){
        if(!$this->link){
            $defaultDb= require _SHELL_DIR . '/config/run.config.php';//print_r($defaultDb);die;
     ...
     * @return string|int
     */
    public function count($table,$where=array(),$columnName='*'){
     ...
     * @throws Exception
     */
    public function min($table,$columnName,$where=array()){
        if(empty($columnName)){
     ...
     * @throws Exception
     */
    public function max($table,$columnName,$where=array()){
        if(empty($columnName)){
     ...
     * @throws Exception
     */
    public function avg($table,$columnName,$where=array()){
        if(empty($columnName)){
     ...
     * @throws Exception
     */
    public function sum($table,$columnName,$where=array()){
        if(empty($columnName)){
